...
pubs2 <- pubs %>%
  stringdist_left_join(gs2, by = "title", max_dist = 1) %>% 
...
#    author=str_replace_all(author, ", \\.\\.\\.", " et al."),
  ...
  glue_google=ifelse(cites==0,"",paste('(<a title="Citations from Google Scholar" href="https://scholar.google.com/scholar?oi=bibs&hl=en&cites=',cid,'" target="_blank"><img alt="Altmetric" src="images/google.png" width="15px"><font color="blue">',cites,')</font></a>')),
  glue_altmetric=ifelse(altmetric_score<0.1|is.na(altmetric_score),"",paste('<a title="Altmetric Score" href="https://www.altmetric.com/details/{altmetric_id}" target="_blank"><img alt="Altmetric" src="images/altm.png" width="15px"><font color="darkred">',round(as.numeric(altmetric_score),1),'</font></a>')),
  glue_media=paste(ifelse(!is.na(media.x),paste('Media Links:',media.x),"")))
